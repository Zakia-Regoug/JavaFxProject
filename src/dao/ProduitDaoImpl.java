...
public class ProduitDaoImpl implements ProduitDao {
    ...
    public Produit findOne(int id) {
        ...
        Produit p=new Produit();
        try{
            PreparedStatement stm=connection.prepareStatement("select * from PRODUITS where ID like ?");
            stm.setInt(1,id);
            ResultSet rs=stm.executeQuery();
    ...
    public Produit save(Produit o) {
        ...
        //il faut retourner l'objet creer dans la bd avec son id(select)
        return o;
    }
    ...
    @Override
    public List<Produit> findPrdByMc(String Mc) {
        Connection connection=SingletonConnectionDB.getConnection();
        List<Produit> produits=new ArrayList<>();
        try {
            PreparedStatement stm=connection.prepareStatement("select * from PRODUITS where NOM like ?");
            stm.setString(1,"%"+Mc+"%");
            ResultSet rs=stm.executeQuery();
